...
type Encoder interface {
	// Encode takes messages from a messages channel, encodes them in the desired format, and writes them to
...
// Decoder is a module that is responsible for decoding a binary data stream into audit log messages.
